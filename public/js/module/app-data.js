  ...
  $.extend(true, AppData, Events, {
    ...
    getAds: function (callback) {
      ...
      cv.getAds(function (ads) {
          ...
          var filteredAds = ads.filter((ad) =>  ad.targetKey === "html5")

          console.log("Filtrar los anuncios que coincidan con el tipo de anuncio deseado:", filteredAds);

          // Procesar los anuncios recibidos
          var processedAds = filteredAds.map(ad => ({
              id: ad.adId,
              ...
              activationTime: ad.activationTime ? new Date(ad.activationTime) : null,
              ...
              isGeneral: ad.isGeneral || false // Anuncio general o específico
          }));
